    ...
    <form onSubmit={handleSend} className="max-w-6xl mx-auto bg-white/90 backdrop-blur-sm p-6 md:p-8 rounded-2xl shadow-xl">
      <div className="md:flex md:gap-8">
        ...
        <aside className="md:w-80 mt-6 md:mt-0">
          <div className="rounded-2xl overflow-hidden shadow-md bg-gradient-to-br from-white to-amber-50 p-0">
            <div className="p-4">
              <h4 className="text-lg font-semibold mb-1">Contact Office</h4>
              <p className="text-sm text-gray-600">We're here to help. Call or message us directly via WhatsApp or use the form and we'll get back to you.</p>
              ...
              <div className="mt-4 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex flex-col items-end gap-2">
                    <a href="tel:+234095123467" className="px-3 py-1 rounded bg-amber-600 text-white text-sm">Call</a>
                    <button onClick={() => copyToClipboard('+234095123467','phone')} className="px-2 py-1 border rounded text-sm">{copied==='phone' ? 'Copied' : 'Copy'}</button>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <a target="_blank" rel="noreferrer" href={`https://wa.me/234095123467?text=${encodeURIComponent("Hello, I would like to get in touch.")}`} className="px-3 py-1 rounded bg-emerald-500 text-white text-sm">Message</a>
                </div>
