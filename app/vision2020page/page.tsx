...
export default function Vision2020P() {
  return (
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <div className="absolute inset-0 bg-[url('/logofolder/golargelogo.png')] bg-center bg-no-repeat opacity-[0.03] bg-fixed pointer-events-none"></div>
      
      {/* Hero Section */}
      <section className="relative py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        {/* Background Decoration */}
        <div className="absolute inset-0 z-0">
          <div className="absolute top-0 left-0 w-96 h-96 bg-blue-200/40 rounded-full filter blur-3xl transform -translate-x-1/2 -translate-y-1/2"></div>
          <div className="absolute bottom-0 right-0 w-96 h-96 bg-red-200/40 rounded-full filter blur-3xl transform translate-x-1/2 translate-y-1/2"></div>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          >
            <h1 className="relative inline-block">
              <span className="text-4xl md:text-5xl lg:text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-indigo-500 to-red-600 mb-6 tracking-tight leading-tight">
            ...
            <motion.p 
              ...
              className="text-xl md:text-2xl lg:text-3xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-red-500 max-w-3xl mx-auto mt-8"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            ...
            <motion.div
              ...
              className="rounded-2xl p-8 bg-white border border-gray-200 shadow-sm text-slate-800"
            >
              ...
              <p className="text-right text-slate-600 font-semibold">— Genesis 27:28–29</p>
            </motion.div>
          ...
          >
            ...
            <motion.div
              ...
              className="rounded-xl p-6 bg-white border border-gray-200 shadow-sm text-slate-800"
            >
              ...
              <p className="text-right mt-4 text-slate-600">— Genesis 31:38, 41</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-right mt-4 text-slate-600">— Genesis 32:10</p>
            </motion.div>
